...
/* 城HTML模板 */
Vcity._template = [
    '<p class="tip">直接输入可搜索城(支持汉字/拼音)</p>',
    '<ul>',
    '<li class="on">热门城</li>',
    '<li>AB</li>',
    '<li>CD</li>',
...
Vcity.CitySelector.prototype = {
    ...
    inputEvent:function(){
        ...
        //     that.input.select();
        //     if(that.input.value == '城名') that.input.value = '';
        // });
        Vcity._m.on(this.input,'blur',function(){
            // if(that.input.value == '') that.input.value = '城名';
